        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center mb-6">
              <User className="w-8 h-8 mr-2 text-blue-500 stroke-2" />
              <h3 className="text-2xl font-bold">Sign in</h3>
            </div>
            <p className="mb-6 text-gray-600">
              Don't have an account?{" "}
              <Link to="/Login/userRegister" className="text-blue-500 hover:underline">
                Sign up
              </Link>
            </p>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="submit"
                  className="flex items-center px-6 py-3 font-semibold text-white transition-colors duration-300 bg-blue-500 rounded-lg hover:bg-blue-600"
                >
